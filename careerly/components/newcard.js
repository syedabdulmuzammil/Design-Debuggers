    ...
    <div>
      <Padding>
        <div className="border-[1px] rounded-[20px] bg-[#2A2929] border-[#333333] w-fit px-5 py-5 ">
          ...
          <div className="w-[150px] h-fit font-overused text-[14px] leading-[20px] text-[#BABABA] pb-5 ">
            {skill}
          </div>
          ...
          <div className="flex w-full justify-end items-end">
            {eligible && (
              <div className="bg-[#8B66FE] py-[10px] px-[19px] rounded-[13px] w-[93px] h-[39px]">
                <div className="font-space text-[15px] leading-[20px] font-medium text-[#FFFFFF] ">
                  Register
                </div>
              </div>
            )}
